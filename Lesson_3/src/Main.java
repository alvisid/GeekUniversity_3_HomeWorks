...
// следующая конструкция:
    ...
    public static void main(String[] args) throws IOException {
        ...
        arrayList2.add(new FileInputStream("1.txt"));
        arrayList2.add(new FileInputStream("2.txt"));
        arrayList2.add(new FileInputStream("3.txt"));
        arrayList2.add(new FileInputStream("4.txt"));
        arrayList2.add(new FileInputStream("5.txt"));
