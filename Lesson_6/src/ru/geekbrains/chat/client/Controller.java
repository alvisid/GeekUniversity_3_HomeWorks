...
import ru.geekbrains.chat.client.network.IncomeMessageHandler;
import ru.geekbrains.chat.client.network.Network;
...
public class Controller implements IncomeMessageHandler {
    ...
    private static final Logger contrLogger = LogManager.getLogger(Controller.class);
...
//        txtPassword.setOnAction(this::okBttnCLicked);
    ...
    public boolean authorize(String login, String password, String action) {
        try {
            ...
            contrLogger.error(e + "Authorization ERROR");
            return false;
        } catch (IOException e) {
            e.printStackTrace();
            return false;
    ...
    private void okBttnCLicked(ActionEvent event) {
        ...
        try {
            ...
            contrLogger.error(e + "No network connection");
        }
        txtPassword.clear();
